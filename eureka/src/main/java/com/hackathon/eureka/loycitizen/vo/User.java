...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", memberId=" + memberId + ", fname=" + fname + ", mname=" + mname + ", lname="
				+ lname + ", salutation=" + salutation + ", email=" + email + ", city=" + city + ", province="
				+ province + ", locality=" + locality + ", countryCode=" + countryCode + ", address=" + address
				+ ", phoneNo=" + phoneNo + ", countyDialerCode=" + countyDialerCode + ", postalCode=" + postalCode
				+ ", mobileNumber=" + mobileNumber + ", dob=" + dob + ", gender=" + gender + ", isValidated="
				+ isValidated + ", creationDate=" + creationDate + ", updationDate=" + updationDate + ", password="
				+ password + "]";
	}
